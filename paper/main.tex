...
\lpft{} spending $50\%$, and and only the trigger family (\fw{} and its
\bcd{} ablation) improves at low budget on never back-propagating deep at
all; a single backoff parameter further
...
every tested budget on the transformer. Three mechanism findings accompany the
