...
on never back-propagating deep at all; a single backoff parameter further
acts as a budget dial, tracing a monotone compute--quality curve
($6$--$49\%$ budgets) that dominates every fixed schedule we tested on the
transformer. Three mechanism findings accompany the
