...
\paragraph{Question 1: does the low-budget result transfer?} The claim is
...
\paragraph{Question 2: is there a budget dial?} Sweeping the trigger
...
\paragraph{Question 3: is the freezing ratchet's strength robust?} At
...
\paragraph{Question 4: does interleaving toxicity survive the optimizer
change?} It worsens. Periodic interleaving is destructive at every budget
...
\paragraph{Question 5: should optimizer state be episodic?}
...
\paragraph{Question 6: is deep-first enough on a stationary task?} Only if
...
\paragraph{Question 7: what happens when the data changes?} We switch the
...
\paragraph{Question 8: can the trigger be made shift-aware?} \fw{}'s
