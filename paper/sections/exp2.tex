...
\paragraph{Question 1: at a matched low budget, do adaptive bursts beat
fixed schedules?} The claim under test is that \emph{when} deep steps are
...
\paragraph{Question 2: why do interleaved fixed schedules fail?} Without
...
\paragraph{Question 3: is the block choice the active ingredient?} \bcd{}
...
\paragraph{Question 4: how does \fw{} compare to progressive freezing?}
