...
\textsc{ftlp}($s$) & reverse of \lpft{}: full BP for the first fraction $s$
of training, then front steps forever (``deep-first''). \\
\textsc{pburst}($P$) & open-loop control for the trigger: bursts of $B$
consecutive full steps every $P$ steps, on a clock, no loss signal. \\
\midrule
...
\midrule
\multicolumn{2}{l}{\emph{Origins-study terms---needed only for Appendix~\ref{sec:exp1}}} \\
\midrule
