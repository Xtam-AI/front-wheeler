...
We evaluate in three stages: controlled MLPs under SGD
(Section~\ref{sec:exp2}); a transformer under AdamW, where the optimizer
itself enters the mechanism (Section~\ref{sec:exp3}); and the wiring study
that supplied the method's premise (Section~\ref{sec:exp1}).
