...
Two implementation failure modes of the mask-search rules---a silent sign
error in straight-through mask gradients, and Hebbian runaway---are
documented in Appendix~\ref{app:failures}.
